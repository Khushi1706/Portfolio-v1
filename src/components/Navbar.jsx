            ...
            >
              {links.map((el) => (
                <li className="cursor-pointer">
                  <Link
                    to={el.route}
                    activeClass={"text-white bg-purple-900"}
                    spy={true}
                    smooth={true}
                    className={
                      darkMode
                        ? "block py-2 px-3 text-purple-900 font-semibold hover:bg-purple-900 hover:text-white font-semibold rounded-md"
                        : "block py-2 px-3 text-white font-semibold hover:bg-purple-500 hover:text-purple-900 font-semibold rounded-md"
                    }
                  >
                    {el.name}
                  </Link>
            ...
            <ul className="md:hidden md:flex-row md:space-y-8 md:mt-0 md:text-md md:font-medium">
              {links.map((el) => (
                <Link
                  ...
                  className={
                    darkMode
                      ? "hover:bg-purple-500 text-black block px-3 py-2 rounded-md text-base font-medium mt-1 hover:text-white"
                      : "hover:bg-purple-500 text-white block px-3 py-2 rounded-md text-base font-medium mt-1 hover:text-white"
                  }
                  spy={true}
                  smooth={true}
